...
def ingest_pdf(
    ...
    Embeddings are generated in batches of 50 chunks.
    """
    ...
    try:
        ...
        for i in range(0, len(chunks), BATCH_SIZE):
            ...
            # First batch becomes the main vector store
        ...
        # FAISS keeps the document text,
        # so the temporary PDF can be deleted.
...
def chat_node(
    ...
    system_message = SystemMessage(
        ...
        content=(
            ...
            "You can also use the web search, "
            "stock price, and calculator tools "
            "when helpful. "

            "If no document is available, ask the "
            "user to upload a PDF."
